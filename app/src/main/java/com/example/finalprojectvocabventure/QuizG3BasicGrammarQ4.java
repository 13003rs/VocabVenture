...
public class QuizG3BasicGrammarQ4 extends AppCompatActivity {

    Button btnProperNoun, btnCommonNoun;

    dialog_wrong wrongDialog = new dialog_wrong(QuizG3BasicGrammarQ5.class);

    dialog_correct correctDialog = new dialog_correct(QuizG3BasicGrammarQ5.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g3_basic_grammar_q4);
