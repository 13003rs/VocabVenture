...
public class g3InterSpellingQuiz1 extends AppCompatActivity {
    TextToSpeech txtToSpeech;
    SharedPreferencesManager preferencesManager;
    EditText ansBox;
    ImageButton soundBtn, clearBtn;
    Button checkBtn;
    dialog_wrong wrongDialog = new dialog_wrong(g3InterSpellingQuiz2.class);
    dialog_correct correctDialog = new dialog_correct(g3InterSpellingQuiz2.class);

    private String correctAns = "PREY"; //--Initializing the correct answer

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g3_inter_spelling_quiz1);
        init();
        playSound();
        setClearBtn();
        ...
        checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isEditTextEmpty()) {
                    ...
                    Toast.makeText(g3InterSpellingQuiz1.this, "Hey there, please fill in the answer.", Toast.LENGTH_SHORT).show();
                } else {
