...
public class g4AdvRead3 extends AppCompatActivity {
    ImageView play;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_adv_read3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(g4AdvRead3.this, HomeActivity.class);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(g4AdvRead3.this, g4AdvRead3Next.class);
                startActivity(intent);
            }
        });
