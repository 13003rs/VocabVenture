...
public class g4AdvSpelling5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_adv_spelling5);
        init();
        buttons();
    }
    public void init(){
    ...
    public void buttons(){ //-- method for the function of the buttons
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() { //-- for the next button
            ...
            public void onClick(View view) {
                Intent nextAct=new Intent(g4AdvSpelling5.this,g4AdvSpelling6.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {  //-- for the back button
            ...
            public void onClick(View v) {
                Intent backAct=new Intent(g4AdvSpelling5.this,g4AdvSpelling4.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() { //--for the home button
            @Override
            public void onClick(View view) {
                Intent homeAct=new Intent(g4AdvSpelling5.this,HomeActivity.class);
