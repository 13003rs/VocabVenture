...
public class QuizG5BasicSpellingQ3 extends AppCompatActivity {
    SharedPreferencesManager preferencesManager;
    Button sound,check,sen;
    EditText answer;
    TextToSpeech txtToSpeech;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG5BasicSpellingQ4.class);
    dialog_correct correctDialog = new dialog_correct(QuizG5BasicSpellingQ4.class);
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g5_basic_spelling_q3);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Audible"; //correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG5BasicSpellingQ3.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void playSound() { //-- method for the function of the sound button
        ...
        sen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String textToSpeak = "Her laughter was barely audible in the quiet room.";
                txtToSpeech.speak(textToSpeak, TextToSpeech.QUEUE_FLUSH, null);
            }
        });
    }
