...
public class g3AdvSpellingQuiz3 extends AppCompatActivity {
    TextToSpeech txtToSpeech;
    SharedPreferencesManager preferencesManager;
    EditText ansBox;
    ImageButton soundBtn, clearBtn;
    Button checkBtn;
    dialog_wrong wrongDialog = new dialog_wrong(g3AdvSpellingQuiz4.class);
    dialog_correct correctDialog = new dialog_correct(g3AdvSpellingQuiz4.class);

    private String correctAns = "COLORFUL"; //--Initializing the correct answer

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g3_adv_spelling_quiz3);
        init();
        playSound();
        setClearBtn();
        ...
        checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isEditTextEmpty()) {
                    ...
                    Toast.makeText(g3AdvSpellingQuiz3.this, "Hey there, please fill in the answer.", Toast.LENGTH_SHORT).show();
                } else {
