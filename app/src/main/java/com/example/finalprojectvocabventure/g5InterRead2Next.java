...
public class g5InterRead2Next extends AppCompatActivity {
    VideoView p2;
    ImageView back,next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_inter_read2_next);

        p2 = findViewById(R.id.g5iread2);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g5interp2;
    ...
    private void showDialog() {
        dialog_quiz dialog = new dialog_quiz(QuizG5InterReadQ1.class);
