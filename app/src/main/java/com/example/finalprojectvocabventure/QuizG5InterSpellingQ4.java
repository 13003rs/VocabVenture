...
public class QuizG5InterSpellingQ4 extends AppCompatActivity {
    SharedPreferencesManager preferencesManager;
    Button sound,check;
    EditText answer;
    TextToSpeech txtToSpeech;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG5InterSpellingQ5.class);
    dialog_correct correctDialog = new dialog_correct(QuizG5InterSpellingQ5.class);
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g5_inter_spelling_q4);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Apology"; // correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG5InterSpellingQ4.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
            }
        });
