...
public class QuizG5AdvSpellingQ2 extends AppCompatActivity {
    SharedPreferencesManager preferencesManager;
    Button sound,check,syno,anto;
    EditText answer;
    TextToSpeech txtToSpeech;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG5AdvSpellingQ3.class);
    dialog_correct correctDialog = new dialog_correct(QuizG5AdvSpellingQ3.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_g5_adv_spelling_q2);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Popular"; // correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG5AdvSpellingQ2.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
