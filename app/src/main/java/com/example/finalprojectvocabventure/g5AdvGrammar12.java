...
public class g5AdvGrammar12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_adv_grammar12);
        init();
        buttons();
    }
    public void init(){
    ...
    public void buttons(){ //-- method for the function of the buttons
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct=new Intent(g5AdvGrammar12.this,g5AdvGrammar11.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() { //--for the home button
            @Override
            public void onClick(View view) {
                Intent homeAct=new Intent(g5AdvGrammar12.this,HomeActivity.class);
    ...
    private void showDialog() {
        dialog_quiz dialog = new dialog_quiz(QuizG5AdvGrammarQ1.class);
