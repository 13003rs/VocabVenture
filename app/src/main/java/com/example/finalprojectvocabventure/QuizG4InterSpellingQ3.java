...
public class QuizG4InterSpellingQ3 extends AppCompatActivity {
    SharedPreferencesManager preferencesManager;
    Button sound,check,sen;
    EditText answer;
    TextToSpeech txtToSpeech;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG4InterSpellingQ4.class);
    dialog_correct correctDialog = new dialog_correct(QuizG4InterSpellingQ4.class);
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_inter_spelling_q3);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Gallery"; //correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG4InterSpellingQ3.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void playSound() { //-- method for the function of the sound button
        ...
        sen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String textToSpeak = "They visited an art gallery to see the new exhibit.";
                txtToSpeech.speak(textToSpeak, TextToSpeech.QUEUE_FLUSH, null);
            }
        });
    }
