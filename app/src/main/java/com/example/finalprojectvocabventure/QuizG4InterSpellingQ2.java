...
public class QuizG4InterSpellingQ2 extends AppCompatActivity {
    SharedPreferencesManager preferencesManager;
    Button sound,check,sen;
    EditText answer;
    TextToSpeech txtToSpeech;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG4InterSpellingQ3.class);
    dialog_correct correctDialog = new dialog_correct(QuizG4InterSpellingQ3.class);
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_inter_spelling_q2);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Crystal"; //correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG4InterSpellingQ2.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void playSound() { //-- method for the function of the sound button
        ...
        sen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String textToSpeak = "The crystal sparkled in the sunlight.";
                txtToSpeech.speak(textToSpeak, TextToSpeech.QUEUE_FLUSH, null);
            }
        });
    }
