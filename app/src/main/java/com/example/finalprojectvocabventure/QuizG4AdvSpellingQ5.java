...
public class QuizG4AdvSpellingQ5 extends AppCompatActivity {
    SharedPreferencesManager preferencesManager;
    Button sound,check;
    EditText answer;
    TextToSpeech txtToSpeech;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG4AdvSpellingQ6.class);
    dialog_correct correctDialog = new dialog_correct(QuizG4AdvSpellingQ6.class);
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_adv_spelling_q5);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Prepay"; // correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG4AdvSpellingQ5.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
            }
        });
