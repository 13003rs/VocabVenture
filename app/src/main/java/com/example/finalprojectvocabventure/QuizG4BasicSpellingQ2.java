...
public class QuizG4BasicSpellingQ2 extends AppCompatActivity {
     int presCounter = 0;
     int maxPresCounter = 5;
     String[] keys = {"G", "D", "T", "I", "I","K"};
     ArrayList<TextView> clickedKeys = new ArrayList<>();
     String textAnswer = "DIGIT";
     SharedPreferencesManager preferencesManager;
    TextView  textTitle;
    Animation smallbigforth;
    Button check;
    ImageButton cancel;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG4BasicSpellingQ3.class);
    dialog_correct correctDialog = new dialog_correct(QuizG4BasicSpellingQ3.class);

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_basic_spelling_q2);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (presCounter == maxPresCounter) {
                    ...
                    Toast.makeText(QuizG4BasicSpellingQ2.this, "Please complete entering the word.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //animation
