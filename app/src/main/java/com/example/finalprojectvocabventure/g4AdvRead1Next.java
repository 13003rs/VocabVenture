...
public class g4AdvRead1Next extends AppCompatActivity {
    VideoView p1;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_adv_read1_next);

        p1 = findViewById(R.id.g4aread1);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g4advp1;
