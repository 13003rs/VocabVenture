...
public class g5InterGrammar15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_inter_grammar15);
        init();
        buttons();
    }
    public void init(){
    ...
    public void buttons(){ //-- method for the function of the buttons
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct=new Intent(g5InterGrammar15.this, g5InterGrammar14.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() { //--for the home button
            @Override
            public void onClick(View view) {
                Intent homeAct=new Intent(g5InterGrammar15.this,HomeActivity.class);
    ...
    private void showDialog() {
        dialog_quiz dialog = new dialog_quiz(QuizG5InterGrammarQ1.class);
