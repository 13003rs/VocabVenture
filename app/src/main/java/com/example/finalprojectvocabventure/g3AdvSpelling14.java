...
public class g3AdvSpelling14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_adv_spelling14);
        init();
        buttons();
    }
    public void init(){
    ...
    public void buttons(){ //-- method for the function of the buttons
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() { //-- for the next button
            ...
            public void onClick(View view) {
                Intent nextAct=new Intent(g3AdvSpelling14.this,g3AdvSpelling15.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {  //-- for the back button
            ...
            public void onClick(View v) {
                Intent backAct=new Intent(g3AdvSpelling14.this,g3AdvSpelling13.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() { //--for the home button
            @Override
            public void onClick(View view) {
                Intent homeAct=new Intent(g3AdvSpelling14.this,HomeActivity.class);
