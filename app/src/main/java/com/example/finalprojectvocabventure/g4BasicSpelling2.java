...
public class g4BasicSpelling2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_basic_spelling2);
    ...
    public void buttons(){ //-- method for the function of the buttons
        nextBtn.setOnClickListener(new View.OnClickListener() { //-- for the next button
            ...
            public void onClick(View view) {
                Intent nextAct=new Intent(g4BasicSpelling2.this,g4BasicSpelling3.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() { //-- for back button
            @Override
            public void onClick(View view) {
                Intent backAct=new Intent(g4BasicSpelling2.this, g4BasicSpelling1.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() { //--for the home button
            @Override
            public void onClick(View view) {
                Intent homeAct=new Intent(g4BasicSpelling2.this,HomeActivity.class);
