...
public class g3InterRead3Next extends AppCompatActivity {
    VideoView p3;
    ImageView back, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_inter_read3_next);

        p3 = findViewById(R.id.g3iread3);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g3interp3;
    ...
    private void showDialog() {
        dialog_quiz dialog = new dialog_quiz(QuizG3InterReadQ1.class);
