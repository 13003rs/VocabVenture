...
public class g3BasicSpelling6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_basic_spelling6);
        init();
        buttons();
        playSound();
    }
    ...
    public void buttons(){
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nextAct = new Intent(g3BasicSpelling6.this, g3BasicSpelling7.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct = new Intent(g3BasicSpelling6.this, g3BasicSpelling5.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent homeAct = new Intent(g3BasicSpelling6.this, HomeActivity.class);
    ...
    public void playSound() { //-- method for the function of the sound button
        ...
        soundBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String textToSpeakthumb = "thumb";
                float speechRatelamb= 0.7f;
                txtToSpeech.setSpeechRate(speechRatelamb);
                txtToSpeech.speak(textToSpeakthumb, TextToSpeech.QUEUE_FLUSH, null, null);
                ...
                String textToSpeakSpell = "t. h. u. m. b";
                ...
                try {
                    Thread.sleep(4000); // 1000 milliseconds (1 second) delay
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
