...
public class g3InterSpellingQuiz3  extends AppCompatActivity {
    TextToSpeech txtToSpeech;
    SharedPreferencesManager preferencesManager;
    EditText ansBox;
    ImageButton soundBtn, clearBtn;
    Button checkBtn;
    dialog_wrong wrongDialog = new dialog_wrong(g3InterSpellingQuiz4.class);
    dialog_correct correctDialog = new dialog_correct(g3InterSpellingQuiz4.class);

    private String correctAns = "ELEPHANT"; //--Initializing the correct answer
        ...
        checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isEditTextEmpty()) {
                    ...
                    Toast.makeText(g3InterSpellingQuiz3.this, "Hey there, please fill in the answer.", Toast.LENGTH_SHORT).show();
                } else {
