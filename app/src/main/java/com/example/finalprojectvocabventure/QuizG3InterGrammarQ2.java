...
public class QuizG3InterGrammarQ2 extends AppCompatActivity {

    Button btnPositive, btnComparative, btnSuperlative;

    dialog_wrong wrongDialog = new dialog_wrong(QuizG3InterGrammarQ3.class);

    dialog_correct correctDialog = new dialog_correct(QuizG3InterGrammarQ3.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g3_inter_grammar_q2);
