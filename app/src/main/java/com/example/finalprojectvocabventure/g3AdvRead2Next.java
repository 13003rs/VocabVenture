...
public class g3AdvRead2Next extends AppCompatActivity {
    VideoView p2;
    ImageView back, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_adv_read2_next);

        p2 = findViewById(R.id.g3aread2);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g3advp2;
        p2.setVideoURI(Uri.parse(videoPath));

        MediaController mediaController = new MediaController(this);
        mediaController.setAnchorView(p2);

        // Set media controller to the VideoView
        p2.setMediaController(mediaController);
        p2.start();
    }
    ...
    private void toggleFullscreen() {
        ...
        fullscreenButton.setText(isFullscreen ? "FULLSCREEN" : "EXIT FULLSCREEN");
    ...
    private void showDialog() {
        dialog_quiz dialog = new dialog_quiz(QuizG3AdvReadQ1.class);
