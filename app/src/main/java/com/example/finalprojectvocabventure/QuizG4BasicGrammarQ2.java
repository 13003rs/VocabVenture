...
public class QuizG4BasicGrammarQ2 extends AppCompatActivity {

    Button btnCountNoun, btnMassNoun;

    dialog_wrong wrongDialog = new dialog_wrong(QuizG4BasicGrammarQ3.class);

    dialog_correct correctDialog = new dialog_correct(QuizG4BasicGrammarQ3.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_basic_grammar_q2);
