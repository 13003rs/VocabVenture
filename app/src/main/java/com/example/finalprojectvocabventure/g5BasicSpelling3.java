...
public class g5BasicSpelling3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_basic_spelling3);
    ...
    public void buttons(){ //-- method for the function of the buttons
        nextBtn.setOnClickListener(new View.OnClickListener() { //-- for the next button
            ...
            public void onClick(View view) {
                Intent nextAct=new Intent(g5BasicSpelling3.this,g5BasicSpelling4.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() { //-- for back button
            @Override
            public void onClick(View view) {
                Intent backAct=new Intent(g5BasicSpelling3.this,g5BasicSpelling2.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() { //--for the home button
            @Override
            public void onClick(View view) {
                Intent homeAct=new Intent(g5BasicSpelling3.this,HomeActivity.class);
