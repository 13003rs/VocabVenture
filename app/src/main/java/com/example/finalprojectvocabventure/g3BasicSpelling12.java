...
public class g3BasicSpelling12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_basic_spelling12);
        init();
        buttons();
        playSound();
    }
    ...
    public void buttons(){
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nextAct = new Intent(g3BasicSpelling12.this, g3BasicSpelling13.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct = new Intent(g3BasicSpelling12.this, g3BasicSpelling11.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent homeAct = new Intent(g3BasicSpelling12.this, HomeActivity.class);
    ...
    public void playSound() { //-- method for the function of the sound button
        ...
        soundBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String textToSpeakSpell = "a. l. i. g. n";
