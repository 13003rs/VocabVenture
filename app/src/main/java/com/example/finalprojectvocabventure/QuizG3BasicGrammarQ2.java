...
public class QuizG3BasicGrammarQ2 extends AppCompatActivity {

    Button btnProperNoun, btnCommonNoun;

    dialog_wrong wrongDialog = new dialog_wrong(QuizG3BasicGrammarQ3.class);

    dialog_correct correctDialog = new dialog_correct(QuizG3BasicGrammarQ3.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g3_basic_grammar_q2);
