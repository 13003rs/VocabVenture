...
public class g4InterRead3Next extends AppCompatActivity {
    VideoView p3;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_inter_read3_next);

        p3 = findViewById(R.id.g4iread3);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g4interp3;
