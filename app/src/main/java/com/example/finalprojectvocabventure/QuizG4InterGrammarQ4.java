...
public class QuizG4InterGrammarQ4 extends AppCompatActivity {

    Button btnIs, btnAm, btnAre;

    dialog_wrong wrongDialog = new dialog_wrong(QuizG4InterGrammarQ5.class);

    dialog_correct correctDialog = new dialog_correct(QuizG4InterGrammarQ5.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_inter_grammar_q4);
