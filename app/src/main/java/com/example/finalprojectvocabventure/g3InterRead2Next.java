...
public class g3InterRead2Next extends AppCompatActivity {
    VideoView p2;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_inter_read2_next);

        p2 = findViewById(R.id.g3iread2);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g3interp2;
