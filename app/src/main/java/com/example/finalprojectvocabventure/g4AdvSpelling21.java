...
public class g4AdvSpelling21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_adv_spelling21);
        init();
        buttons();
        playSound();
    }
    ...
    public void buttons(){
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct = new Intent(g4AdvSpelling21.this, g4AdvSpelling20.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent homeAct = new Intent(g4AdvSpelling21.this, HomeActivity.class);
    ...
    private void showDialog() {
        dialog_quiz dialog = new dialog_quiz(QuizG4AdvSpellingQ1.class);
