...
public class QuizG5AdvReadQ8 extends AppCompatActivity {

    Button directions, doctor, large;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_g5_adv_read_q8);
    ...
    public void init(){
        directions = findViewById(R.id.btnDirect);
        doctor = findViewById(R.id.btnBill);
        large = findViewById(R.id.btnBandage);
    }
        ...
        doctor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), "You clicked A bill from a doctor", Toast.LENGTH_SHORT).show();
                    }
                }, 200);
            }
        });
        ...
        large.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), "You clicked A large bandage", Toast.LENGTH_SHORT).show();
                    }
                }, 200);
            }
        });
        ...
        directions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), "You clicked Directions on how to take medicines", Toast.LENGTH_SHORT).show();
                    }
                }, 200);
            }
        });
