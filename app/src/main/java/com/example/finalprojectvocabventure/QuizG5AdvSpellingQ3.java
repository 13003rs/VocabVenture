...
public class QuizG5AdvSpellingQ3 extends AppCompatActivity {
    SharedPreferencesManager preferencesManager;
    Button sound,check,syno,anto;
    EditText answer;
    TextToSpeech txtToSpeech;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG5AdvSpellingQ4.class);
    dialog_correct correctDialog = new dialog_correct(QuizG5AdvSpellingQ4.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_g5_adv_spelling_q3);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Sad"; // correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG5AdvSpellingQ3.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
