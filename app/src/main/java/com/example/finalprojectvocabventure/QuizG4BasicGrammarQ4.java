...
public class QuizG4BasicGrammarQ4 extends AppCompatActivity {

    Button btnCountNoun, btnMassNoun;

    dialog_wrong wrongDialog = new dialog_wrong(QuizG4BasicGrammarQ5.class);

    dialog_correct correctDialog = new dialog_correct(QuizG4BasicGrammarQ5.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_basic_grammar_q4);
