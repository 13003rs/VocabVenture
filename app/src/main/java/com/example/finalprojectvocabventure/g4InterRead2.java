...
public class g4InterRead2 extends AppCompatActivity {
    ImageView play;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_inter_read2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(g4InterRead2.this, g4InterRead3.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(g4InterRead2.this, HomeActivity.class);
                startActivity(intent);
            }
        });
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(g4InterRead2.this, g4InterRead2Next.class);
                startActivity(intent);
            }
        });
