...
public class QuizG4BasicSpellingQ3 extends AppCompatActivity {
     int presCounter = 0;
     int maxPresCounter = 7;
     String[] keys = {"S", "G", "R", "U", "Y","R","E"};
     ArrayList<TextView> clickedKeys = new ArrayList<>();
     String textAnswer = "SURGERY";
     SharedPreferencesManager preferencesManager;
    TextView  textTitle;
    Animation smallbigforth;
    Button check;
    ImageButton cancel;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG4BasicSpellingQ4.class);
    dialog_correct correctDialog = new dialog_correct(QuizG4BasicSpellingQ4.class);

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_basic_spelling_q3);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (presCounter == maxPresCounter) {
                    ...
                    Toast.makeText(QuizG4BasicSpellingQ3.this, "Please complete entering the word.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //animation
