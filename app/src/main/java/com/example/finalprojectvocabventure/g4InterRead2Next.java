...
public class g4InterRead2Next extends AppCompatActivity {
    VideoView p2;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_inter_read2_next);

        p2 = findViewById(R.id.g4iread2);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g4interp2;
