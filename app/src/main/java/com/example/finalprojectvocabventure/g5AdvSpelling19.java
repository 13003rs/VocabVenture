...
public class g5AdvSpelling19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_adv_spelling19);
        init();
        buttons();
        playSound();
    }
    ...
    public void buttons(){
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nextAct = new Intent(g5AdvSpelling19.this, g5AdvSpelling20.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct = new Intent(g5AdvSpelling19.this, g5AdvSpelling18.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent homeAct = new Intent(g5AdvSpelling19.this, HomeActivity.class);
