...
public class g3InterSpellingQuiz4  extends AppCompatActivity {
    TextToSpeech txtToSpeech;
    SharedPreferencesManager preferencesManager;
    EditText ansBox;
    ImageButton soundBtn, clearBtn;
    Button checkBtn;
    dialog_wrong wrongDialog = new dialog_wrong(g3InterSpellingQuiz5.class);
    dialog_correct correctDialog = new dialog_correct(g3InterSpellingQuiz5.class);

    private String correctAns = "DOLPHIN"; //--Initializing the correct answer

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g3_inter_spelling_quiz4);
        init();
        playSound();
        setClearBtn();
        ...
        checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isEditTextEmpty()) {
                    ...
                    Toast.makeText(g3InterSpellingQuiz4.this, "Hey there, please fill in the answer.", Toast.LENGTH_SHORT).show();
                } else {
