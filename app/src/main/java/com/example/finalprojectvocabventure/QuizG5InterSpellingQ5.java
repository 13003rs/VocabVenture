...
public class QuizG5InterSpellingQ5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_g5_inter_spelling_q5);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Submerge"; // correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG5InterSpellingQ5.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void uploadInterSpellingScoreToFirebase() {
        ...
        userDb.orderByChild("LoggedIn").equalTo(1).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                for (DataSnapshot userSnapshot : snapshot.getChildren()) {
                    ...
                    interSpellingScoreRef.setValue(score)
                            .addOnSuccessListener(aVoid -> {
                                ...
                                Toast.makeText(QuizG5InterSpellingQ5.this, "Score uploaded to Firebase!", Toast.LENGTH_SHORT).show();
                            })
                            .addOnFailureListener(e -> {
                                // Handle failure
                                // You can add logging or additional logic here
                                Toast.makeText(QuizG5InterSpellingQ5.this, "Failed to upload score to Firebase", Toast.LENGTH_SHORT).show();
                            });
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(QuizG5InterSpellingQ5.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
