...
public class g5AdvRead1Next extends AppCompatActivity {
    VideoView p1;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_adv_read1_next);

        p1 = findViewById(R.id.g5aread1);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g5advp1;
