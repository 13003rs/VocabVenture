...
public class g4InterRead3 extends AppCompatActivity {
    ImageView play;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g4_inter_read3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(g4InterRead3.this, HomeActivity.class);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(g4InterRead3.this, g4InterRead3Next.class);
                startActivity(intent);
            }
        });
