...
public class g5InterSpelling21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_inter_spelling21);
        init();
        buttons();
        playSound();
    }
    ...
    public void buttons(){
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nextAct = new Intent(g5InterSpelling21.this, g5InterSpelling22.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct = new Intent(g5InterSpelling21.this, g5InterSpelling20.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent homeAct = new Intent(g5InterSpelling21.this, HomeActivity.class);
