...
public class g3BasicSpelling4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_basic_spelling4);
        init();
        buttons();
        playSound();
    }

    public void init() { // -- for initializing the variables
    ...
    public void buttons() { //-- method for the function of the buttons (home, next and back)
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nextAct = new Intent(g3BasicSpelling4.this, g3BasicSpelling5.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct = new Intent(g3BasicSpelling4.this, g3BasicSpelling3.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent homeAct = new Intent(g3BasicSpelling4.this, HomeActivity.class);
    ...
    public void playSound() { //-- method for the function of the sound button
        ...
        soundBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String textToSpeakComb = "COMB";
                float speechRateComb = 0.7f;
                txtToSpeech.setSpeechRate(speechRateComb);
                txtToSpeech.speak(textToSpeakComb, TextToSpeech.QUEUE_FLUSH, null, null);
                ...
                String textToSpeakSpell = "C. O. M. B";
