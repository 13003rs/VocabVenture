...
public class QuizG4InterGrammarQ2 extends AppCompatActivity {

    Button btnIs, btnAm, btnAre;

    dialog_wrong wrongDialog = new dialog_wrong(QuizG4InterGrammarQ3.class);

    dialog_correct correctDialog = new dialog_correct(QuizG4InterGrammarQ3.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_inter_grammar_q2);
