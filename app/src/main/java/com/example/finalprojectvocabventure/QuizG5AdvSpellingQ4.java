...
public class QuizG5AdvSpellingQ4 extends AppCompatActivity {
    SharedPreferencesManager preferencesManager;
    Button sound,check,syno,anto;
    EditText answer;
    TextToSpeech txtToSpeech;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG5AdvSpellingQ5.class);
    dialog_correct correctDialog = new dialog_correct(QuizG5AdvSpellingQ5.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_g5_adv_spelling_q4);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String correctAnswer = "Asleep"; // correct answer
                ...
                if (!userAnswer.isEmpty()) {
                    ...
                    Toast.makeText(QuizG5AdvSpellingQ4.this, "Please enter an answer.", Toast.LENGTH_SHORT).show();
                }
