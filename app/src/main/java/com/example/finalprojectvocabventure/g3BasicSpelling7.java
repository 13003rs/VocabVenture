...
public class g3BasicSpelling7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_basic_spelling7);
        init();
        buttons();
        playSound();
    }
    ...
    public void buttons(){
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nextAct = new Intent(g3BasicSpelling7.this, g3BasicSpelling8.class);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backAct = new Intent(g3BasicSpelling7.this, g3BasicSpelling6.class);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent homeAct = new Intent(g3BasicSpelling7.this, HomeActivity.class);
    ...
    public void playSound(){
        ...
        soundBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String textToSpeaklamb = "plumber";
                ...
                String textToSpeakSpell = "p. l. u. m. b. e. r.";
                ...
                try {
                    Thread.sleep(7000); // 1000 milliseconds (1 second) delay
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
