...
public class QuizG4BasicSpellingQ1 extends AppCompatActivity {
     int presCounter = 0;
     int maxPresCounter = 6;
     String[] keys = {"E", "C", "D", "I", "D","E"};
     ArrayList<TextView> clickedKeys = new ArrayList<>();
     String textAnswer = "DECIDE";
     SharedPreferencesManager preferencesManager;
    TextView  textTitle;
    Animation smallbigforth;
    Button check;
    ImageButton cancel;
    dialog_wrong wrongDialog = new dialog_wrong(QuizG4BasicSpellingQ2.class);
    dialog_correct correctDialog = new dialog_correct(QuizG4BasicSpellingQ2.class);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_g4_basic_spelling_q1);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (presCounter == maxPresCounter) {
                    ...
                    Toast.makeText(QuizG4BasicSpellingQ1.this, "Please complete entering the word.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //animation
