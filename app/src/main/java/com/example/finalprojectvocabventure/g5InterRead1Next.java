...
public class g5InterRead1Next extends AppCompatActivity {
    VideoView p1;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_inter_read1_next);

        p1 = findViewById(R.id.g5iread1);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g5interp1;
