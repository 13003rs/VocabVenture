...
public class QuizG4InterGrammarQ5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_g4_inter_grammar_q5);
    ...
    private void uploadInterGrammarScoreToFirebase() {
        ...
        userDb.orderByChild("LoggedIn").equalTo(1).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                for (DataSnapshot userSnapshot : snapshot.getChildren()) {
                    ...
                    interGrammarScoreRef.setValue(score)
                            .addOnSuccessListener(aVoid -> {
                                ...
                                Toast.makeText(QuizG4InterGrammarQ5.this, "Score uploaded to Firebase!", Toast.LENGTH_SHORT).show();
                            })
                            .addOnFailureListener(e -> {
                                // Handle failure
                                // You can add logging or additional logic here
                                Toast.makeText(QuizG4InterGrammarQ5.this, "Failed to upload score to Firebase", Toast.LENGTH_SHORT).show();
                            });
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(QuizG4InterGrammarQ5.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
