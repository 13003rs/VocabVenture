...
public class g3InterRead1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_inter_read1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentNext = new Intent(g3InterRead1.this, g3InterRead3Next.class);
        ...
        play1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(getBaseContext(), g3InterRead3Next.class);
        ...
        play2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (play2.isEnabled()) {
                    if (isPlay1Clicked) {
                        Intent intentread1 = new Intent(getBaseContext(), g3InterRead1Next.class);
                        startActivity(intentread1);
                        play2.setColorFilter(null); // Remove the color filter
                    } else {
                        // Handle the case where play1 is not clicked
                        Toast.makeText(g3InterRead1.this, "Play1 is not clicked yet.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // Handle the case where play2 is not enabled
                    Toast.makeText(g3InterRead1.this, "Play2 is locked. Please click Play1 first.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
