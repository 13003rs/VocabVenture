...
public class g3AdvSpellingQuiz4 extends AppCompatActivity {
    TextToSpeech txtToSpeech;
    SharedPreferencesManager preferencesManager;
    EditText ansBox;
    ImageButton soundBtn, clearBtn;
    Button checkBtn;
    dialog_wrong wrongDialog = new dialog_wrong(g3AdvSpellingQuiz5.class);
    dialog_correct correctDialog = new dialog_correct(g3AdvSpellingQuiz5.class);

    private String correctAns = "SLOWLY"; //--Initializing the correct answer

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g3_adv_spelling_quiz4);
        init();
        playSound();
        setClearBtn();
        ...
        checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isEditTextEmpty()) {
                    ...
                    Toast.makeText(g3AdvSpellingQuiz4.this, "Hey there, please fill in the answer.", Toast.LENGTH_SHORT).show();
                } else {
