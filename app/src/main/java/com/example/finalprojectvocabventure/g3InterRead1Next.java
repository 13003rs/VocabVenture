...
public class g3InterRead1Next extends AppCompatActivity {
    VideoView p1;
    ImageView back, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_inter_read1_next);

        p1 = findViewById(R.id.g3iread1);
        ...
        //story of THE EGGS AND THE GRASS
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g3interp1;
    ...
    private void showDialog() {
        dialog_quiz dialog = new dialog_quiz(QuizG3InterReadQ7.class);
