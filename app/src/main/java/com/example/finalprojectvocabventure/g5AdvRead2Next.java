...
public class g5AdvRead2Next extends AppCompatActivity {
    VideoView p2;
    ImageView back, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g5_adv_read2_next);

        p2 = findViewById(R.id.g5aread2);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.g5advp2;
    ...
    private void showDialog() {
        dialog_quiz dialog = new dialog_quiz(QuizG5AdvReadQ1.class);
